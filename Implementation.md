...
Put the folders of VOC dataset, Flicker Face high quality dataset and DIV2K dataset, collected old photos (e.g., Real_L_old and Real_RGB_old) into one shared folder. Then
```
cd Global/data/
...
### Train the VAEs of domain A and domain B respectively
...
### Train the mapping network between domains
...
This project has adopted the [Bringing-Old-Photos-Back-to-Life](https://github.com/microsoft/Bringing-Old-Photos-Back-to-Life)
